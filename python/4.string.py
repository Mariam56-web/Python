...
# String containing simple biodata
biodata = "Name: Mariam, Age: 24, Country: Bangladesh"

# Splitting the string to extract each piece of information
pieces = biodata.split(", ")

# Extracting and printing each piece of information separately
for piece in pieces:
...
# Formatted string to include person's information
