...
# Test the function
principal = 1000  # Initial amount (principal)
rate = 0.05       # Annual interest rate
time = 5          # Time in years
periods = 12      # Number of times interest applied per time period (e.g., monthly)

interest_amount = compound_interest(principal, rate, time, periods)
print("Compound interest amount:", round(interest_amount, 2))
...
# Call the function to start printing the current time
print_current_time()
